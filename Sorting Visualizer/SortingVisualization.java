...
public class SortingVisualization extends World
{
    ...
    {    
        ...
        //Step by Step Bubble Sort by Mr. Brooks
        /* 
        BubbleSortVisualizerBrooks sort = new BubbleSortVisualizerBrooks();
        addObject(sort,10,10);
        //*/

        InsertionSortVisualizerMaor sort = new InsertionSortVisualizerMaor();
        addObject(sort, 10, 10);
        //sort.setBlockList(blockList);
        //sort.insertionSort(blockList);
       
        
        //MergeSortVisualizerLomovtseva sortz = new MergeSortVisualizerLomovtseva();
        //addObject(sortz, 10, 10);
        
        //QuickSortVisualizerCallanan sorte = new QuickSortVisualizerCallanan();
        //addObject(sorte, 10, 10);
    ...
    /**
     * Display the list of blocks on the screen in same
     * order as they are stored in the list
     */
